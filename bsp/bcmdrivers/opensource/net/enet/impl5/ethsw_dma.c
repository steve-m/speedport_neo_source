...
int ethsw_setup_phys(void)
{
#if 1    //enable ethernet@wirespeed of GE port, only set bit 4, don't touch other bits
    // uint16 v16 = 0x8217;
    // 53125 p0~p3
	...
	// external PHY on internal switch p4 
	// you might need to check the original value of this register, and only set bit4, don't touch other bits
	ethsw_phy_wreg(BCMSW_PHY_GET_PHYID(0, 4), 0x18, &v16);     
