...
#ifdef _SC_BUILD_
/*
 * Original from xt_PORTTRG.c, moved here to make it connect with conntrack
 */
typedef struct {
	struct list_head list;			/* Trigger list */
        struct list_head master_ct;	/* Trigger conntrack list */
...
struct nf_conn {
	...
	struct {
		...
		*/
        ...
        uint8_t no_sipalg;
        struct net_device *sc_out_dev;
        struct list_head port_triggers;
#endif
};
