...
#ifdef _SC_BUILD_
	fon_stats.rx_packets++;
	fon_stats.rx_bytes += len;
#endif
...
#ifdef _SC_BUILD_
	fon_stats.tx_packets++;
	fon_stats.tx_bytes += len;
#endif
...
#ifdef _SC_BUILD_
                memset(&fon_stats, 0, sizeof(fon_stats));
#endif
		dev_net_set(dev, net);
...
#ifdef _SC_BUILD_
static int read_fon_stats(char *buf, char **start, off_t offset, int count, int *eof, void *data)
{
    int ret;

    ret = sprintf(buf, "%llu,%llu,%llu,%llu\n",
                  fon_stats.rx_packets,
                  fon_stats.rx_bytes,
                  fon_stats.tx_packets,
                  fon_stats.tx_bytes
...
#ifdef _SC_BUILD_
        create_proc_read_entry("fon_stats", 0, NULL, read_fon_stats, &fon_stats);
#endif
