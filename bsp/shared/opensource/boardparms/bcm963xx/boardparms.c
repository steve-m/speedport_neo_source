...
//  {bp_ulAfeId1,                .u.ul = BP_AFE_CHIP_6306 | BP_AFE_LD_6303 | BP_AFE_FE_ANNEXA | BP_AFE_FE_REV_6303_REV_12_3_20 }, 
  ...
  {bp_usGpioExtAFELDPwr,       .u.us = BP_GPIO_NONE},
  {bp_usGpioExtAFELDClk,       .u.us = BP_GPIO_NONE},
  {bp_usGpioExtAFELDData,      .u.us = BP_GPIO_NONE},
  ...
  {bp_usPhyConnType,           .u.us = PHY_CONN_TYPE_PLC },
  {bp_ucPhyDevName,            .u.cp = "plc%d" },
  {bp_ulPortFlags,             .u.ul = PORT_FLAG_SOFT_SWITCHING | PORT_FLAG_TX_INTERNAL_DELAY | PORT_FLAG_RX_INTERNAL_DELAY},
