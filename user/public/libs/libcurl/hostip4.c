 ...
 *
 * $Id: hostip4.c,v 1.1.1.1 2008-04-07 08:44:26 dody_zhang Exp $
 ***************************************************************************/
		...
		{\
			...
			{\
				...
				{\
					...
					fclose(fp);\
					/* domain synchronizing to dnrd */\
                    if(strlen(buf1)) \
					snprintf(buf, sizeof(buf), "/usr/sbin/rc dnrd restart tr069 %s %s >/dev/null 2>&1", hostname, buf1);\
                    else \
					snprintf(buf, sizeof(buf), "/usr/sbin/rc dnrd restart tr069 >/dev/null 2>&1");\
                    system(buf);\
					sleep(1);\
				}\
				else\
                                ...
                                int *waitp)
{
  ...
  *waitp = 0; /* don't wait, we act synchronously */
   ...
   */
    ...
    //h = sc_gethostbyname_r(hostname, DOMAIN_TYPE_TR069,
    ...
    //res = sc_gethostbyname_r(hostname,DOMAIN_TYPE_TR069,
    ...
    //h = sc_gethostbyname(hostname, DOMAIN_TYPE_TR069);
