 ...
 *
 * $Id: urldata.h,v 1.1.1.1 2008-04-07 08:44:27 dody_zhang Exp $
 ***************************************************************************/
...
#ifdef SUPPORT_OD69_CERT
  bool unique_cookie_session;   /* use unique cookie in a session(even redirect happen) */
#endif
...
/* Here follows boolean settings that define how to behave during
  ...
  bool tcp_nodelay;      /* whether to enable TCP_NODELAY or not */
	int dscp;               /* DSCP to use on data socket */
	int priority;               /* PRIORITY to use on data socket */
  long brokentimeout;  /* in seconds, 0 means no brokentimeout */
#ifdef __SC_BUILD__
  char *host_name;     /* compare it with cert peer CN */
#endif
};
