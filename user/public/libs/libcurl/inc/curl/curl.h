 ...
 *
 * $Id: curl.h,v 1.1.1.1 2008-04-07 08:44:27 dody_zhang Exp $
 ***************************************************************************/
...
typedef enum {
  ...
  */
  ...
  CINIT(DSCP, LONG, 141),
  CINIT(PRIORITY, LONG, 142),

  /* 
     Broken Time-out .
     when signal transfer dose not recive any data for a long time.
     Uswer can set number for broken time-out.
  */
  CINIT(BROKENTIMEOUT, LONG, 143),

#ifdef __SC_BUILD__
  CINIT(HOST_NAME, OBJECTPOINT, 144),
#endif

#ifdef SUPPORT_OD69_CERT
  CINIT(UNIQUECOOKIESESSION, LONG, 145),
#endif
