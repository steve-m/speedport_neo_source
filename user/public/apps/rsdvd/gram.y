...
ifaceval	: T_MinRtrAdvInterval NUMBER ';'
		...
		| T_RtrSolInterval NUMBER ';'
		{
			iface->RtrSolInterval = $2;
		}
		| T_RtrSolCount NUMBER ';'
		{
			iface->RtrSolCount = $2;
		}
		...
		| T_RtrDefaultLifetime NUMBER ';'
		{
			iface->RtrDefaultLifetime = $2;
		}
