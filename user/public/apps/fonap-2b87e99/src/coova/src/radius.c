...
#else
    if ((this->queue[this->first].retrans+1) < (_options.radiusretry*_options.radiusretrysec*2)) {
#endif
        /* trigger wan up */
        if(1)
        {
...
#else
      if (((this->queue[this->first].retrans+1)%(_options.radiusretrysec)) == 0) {
#endif
