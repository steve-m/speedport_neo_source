...
#define MAXSTRLEN 256           /* Maximum length of common strings */
...
#ifdef SUPPORT_FON
#define DEFAULT_HELLO_DELAY 120
...
#ifdef SUPPORT_FON
#define DEFAULT_MAX_RETRIES 1    /* Recommended value from spec */
#else
