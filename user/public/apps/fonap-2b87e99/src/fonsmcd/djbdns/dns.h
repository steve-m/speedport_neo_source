...
extern int dns_transmit_start_at_port(struct dns_transmit *,const char *,int,const char *,const char *,const char *, int);
extern int dns_transmit_ipv6_start_at_port(struct dns_transmit *,const char *,int,const char *,const char *,const char *, int);
