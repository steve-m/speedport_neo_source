...
#ifdef SC_DT_SUPPORT
    int discoveryBackupSocket;	/* backup discoverySocket if need */
    int discoveryUntagSocket;	/* untagged Raw socket for discovery frames */
    int method;                 /* index which interface send&receive PADI/PADO currently */
#define SC_TAGGED_IF            1
#define SC_UNTAGGED_IF          0
#endif
...
#ifdef SC_DT_SUPPORT
    char *untagIfName;		/* untagged Interface name */
#endif
...
#ifdef SC_DT_SUPPORT
#define LAST_PADT_INFO  "/mnt/appdat/padt.info"
#endif
