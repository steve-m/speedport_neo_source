...
extern flag seen_only;		/* if --seen was set */
extern flag delete_only;		/* if --delete was set */
extern char *rcfile;		/* path name of rc file */
extern int linelimit;		/* limit # lines retrieved per site */
extern flag versioninfo;	/* emit only version info */
extern char *mail_uid;		/* mail uid for delete */
...
int open_sink(struct query*, struct msgblk *, int*, int*,int);
